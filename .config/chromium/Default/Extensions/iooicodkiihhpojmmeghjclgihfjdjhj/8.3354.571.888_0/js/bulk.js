...
//  ===========
    ...
    //  =============
        function __escapeForHTML(_string)
        {
			...
			//	event
			$R.customEvents.dispatchByName('to-extension--evernote-login');
		};
	...
	var __the_themes = 
	{
		...
		'theme-3':
		{
			...
			//	event
			$R.customEvents.dispatchByName('to-extension--select-'+_theme_id);
    ...
    //  ======
        $R.menu_functions['speak'] = function ()
        {
            ...
            $R.customEvents.dispatchByName('to-extension--evernote-speech');
            return false;
        };
	...
	*/
    ...
    //  =============
		...
		switch (_event_name)
		{
			...
			case 'to-browser--evernote-login-show--in':
            case 'to-browser--evernote-login-show--in-cn':
			case 'to-browser--evernote-login-show--cn':
            case 'to-browser--evernote-login-show--cn-in':
                ...
                //  which login? set class -- if blank, will not change
                if (_event_name.match(/--([a-z]{2})-([a-z]{2})$/))
                    { $('#evernote_login__container_which').attr('class', _event_name.substr(-5).replace('-', '_').toLowerCase()); }
            ...
            case 'to-browser--evernote-speech-start':
                //  detect flash
			...
			case 'to-browser--first-show--all-features':
                //  show
                $R.$features.removeClass('all new').addClass('all');

                //  open dialog
                $R.showDialog('features');

                //  event
                $R.customEvents.dispatchByName('to-extension--first-show--mark');
                
                //	end
				_stop = true;
                break;
                
			case 'to-browser--first-show--new-features':
                //  show
                $R.$features.removeClass('all new').addClass('new');
            ...
            case 'to-browser--show--speech--need-login':
            case 'to-browser--show--speech--need-login--in':
            case 'to-browser--show--speech--need-login--in-cn':
			case 'to-browser--show--speech--need-login--cn':
            case 'to-browser--show--speech--need-login--cn-in':
                //  stop initializing
			...
			case 'to-browser--show--speech--need-premium':
                //  stop initializing
                $R.$html.removeClass('speakInitializing');
	...
	*/
    ...
    //  =======
        ...
        //  ======
            ...
            {
                //$R.customEvents.dispatchByName('to-extension--open-settings-speech');
			...
			//	====
				...
				$R.show(function ()
				{
                    ...
                    //  =============
                            ...
                            if ($R.trackedView); else if ($R.vars)
                            {
                                //  first show?
                                $R.customEvents.dispatchByName('to-extension--first-show--check');
