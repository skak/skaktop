...
mymainmenu = awful.menu( { 
	items = {
		{ "dmenu", "dmenu_run -p skak -nb \"#3F3F3F\" -nf \"#DCDCCC\" -sf \"#F0DFAF\" -sb \"#1E2320\" -b -l 15 -fn Terminus:pixelsize=12", beautiful.awesome_icon },
		{ "awesome", myawesomemenu, beautiful.awesome_icon },
		{ "apps", appsmenu, beautiful.awesome_icon },
		{ "skak", skakmenu, beautiful.awesome_icon },
		{ "terms", termsmenu, beautiful.awesome_icon }
	}
} )

mylauncher = awful.widget.launcher({ image = beautiful.awesome_icon,
                                     menu = mymainmenu })
myChromeLauncher = awful.widget.launcher({   image = beautiful.awesomec, 
										   command = browser })
...
-- skaks wibox on the bottom
	swibBottom[s] = awful.wibox({ position = "bottom", screen = s })
...
-- skaks wibox on the bottom end

-- skaks wibox on the right
	swibRight[s] = awful.wibox({ position = "right", screen = s })
...
-- skaks wibox on the right end

-- skaks wibox on the left
	swibLeft[s] = awful.wibox({ position = "left", screen = s })
...
-- skaks wibox on the left end

-- Create the top wibox
    swibTop[s] = awful.wibox({ position = "top", screen = s })
...
-- }}}
awful.util.spawn_with_shell(gedit .. " /home/skak/.config/awesome/rc.new.lua" )
awful.util.spawn_with_shell(imclient)
--[[
lxapp = "lxappearance"
gvim = "gvim"
gedit = "gedit"
