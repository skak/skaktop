                                    ...
                                    //  ======
                                        ...
                                        //  ==================
                                            ...
                                            var 
                                                ...
                                                _noteURL = (
                                                    _to_business
                                                    ? (__readable_by_evernote.__evernote_bootstrap.remote_domain + 'shard/' +  _shardId + '/' + 'business/dispatch/' + 'view/' + _n.guid + '#st=b' + '&n=' + _n.guid + '&b=' + _n.notebook_guid)
                                                    : (__readable_by_evernote.__evernote_bootstrap.remote_domain + 'shard/' +  _shardId + '/'                        + 'view/' + _n.guid + '#st=p' + '&n=' + _n.guid)
                                                ),
                                                _noteURLAndAuth = ''
                                                    ...
                                                    + '&redirect=' + encodeURIComponent(_noteURL)
                                            ;
                                            __readable_by_evernote.__evernote_remote.store__id_to_info[_id]['url_view'] = _noteURLAndAuth;
                                            __readable_by_evernote.__evernote_remote.store__id_to_info[_id]['url_edit'] = _noteURLAndAuth;
            ...
            //  =================
                var _addAbsoluteURLs = function (_addToThisResult, _use_business)
                {
                    ...
                    //  ====
                        ...
                        {
                            var 
                                _n = _theResult.relatedNotes.list[i],
                                _authToken = (
                                    _use_business 
                                    ? __readable_by_evernote.__evernote_remote.business__authToken 
                                    : __readable_by_evernote.__evernote_remote.user__authToken
                                ...
                                _noteURL = (
                                    _use_business
                                    ? (__readable_by_evernote.__evernote_bootstrap.remote_domain + 'shard/' +  _shardId + '/' + 'business/dispatch/' + 'view/' + _n.guid + '#st=b' + '&n=' + _n.guid + '&b=' + _n.notebookGuid)
                                    : (__readable_by_evernote.__evernote_bootstrap.remote_domain + 'shard/' +  _shardId + '/'                        + 'view/' + _n.guid + '#st=p' + '&n=' + _n.guid)
                                )
                            ;
                            ...
                            //  thumbnail
                            //  =========
                                _theResult.relatedNotes.list[i]['absoluteURL__thumbnail'] = ''
                                    + __readable_by_evernote.__evernote_bootstrap.remote_domain
                                    + 'shard/' +  _shardId + '/'
                                    + 'thm/note/'
                                    + _n.guid
                            ...
                            //  noteView
                            //  ========
                                _theResult.relatedNotes.list[i]['absoluteURL__noteView'] = ''
                                    + __readable_by_evernote.__evernote_bootstrap.remote_domain
                                    + 'setAuthToken?auth=' + encodeURIComponent(__readable_by_evernote.__evernote_remote.user__authToken)
                                    + '&redirect=' + encodeURIComponent(_noteURL)
                                ;
...
var __first_show_identifier = '3354.571.334';
		...
		function (_failReason)
		{
			...
			/* ======== */
				case 'to-chrome--open-settings-theme':
					chrome.tabs.create({ 'selected': true, 'url': 'chrome-extension://iooicodkiihhpojmmeghjclgihfjdjhj/options/options.html#showCustom' });
					sendResponse({});
					break;

				case 'to-chrome--open-settings-speech':
					chrome.tabs.create({ 'selected': true, 'url': 'chrome-extension://iooicodkiihhpojmmeghjclgihfjdjhj/options/options.html#showSpeech' });
					sendResponse({});
					break;
                    
				case 'to-chrome--open-settings':
					chrome.tabs.create({ 'selected': true, 'url': 'chrome-extension://iooicodkiihhpojmmeghjclgihfjdjhj/options/options.html'	});
					sendResponse({});
					break;
